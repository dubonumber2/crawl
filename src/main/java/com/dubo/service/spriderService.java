...
import com.dubo.service.impl.util.ZhiHuUserBeanServiceImpl;
...
public class spriderService {
    ...
    static ZhiHuUserBeanService zhiHuUserBeanService=new ZhiHuUserBeanServiceImpl();
...
//                    String thxNum = thxNumString.substring(thxNumString.indexOf("得") + 2, thxNumString.indexOf("次") - 1);
                   ...
                   /* String sql = "insert into user " +
                    ...
                    //把用户所关注的人的url加入到阻塞队列
                    zhiHuUserBeanService.insertData(user);
