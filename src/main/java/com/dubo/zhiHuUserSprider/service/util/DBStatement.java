package com.dubo.zhiHuUserSprider.service.util;
...
public class DBStatement {
    ...
    private DBStatement(){
        try {
            ...
            String mySqlUrl = "jdbc:mysql://10.0.0.42:3306/dubo?useUnicode=true&characterEncoding=UTF-8&zeroDateTimeBehavior=convertToNull&useOldAliasMetadataBehavior=true";
            String username = "admin";
            String password = "bjksrs@2017";
